...
try {
  const { data } = (await apideck.file) - storage.filesAll(params)
...
try {
  const { data } = (await apideck.file) - storage.filesDelete(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
try {
  const { data } = (await apideck.file) - storage.filesDownload(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
try {
  const { data } = (await apideck.file) - storage.filesOne(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
