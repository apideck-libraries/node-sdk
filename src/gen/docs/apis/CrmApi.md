...
```typescript
crmApi.customObjectSchemasAdd(body)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **customObjectSchema** | [CustomObjectSchema](../models/CustomObjectSchema.md)|  |
 **raw** | [**boolean**] | Include raw response. Mostly used for debugging purposes | (optional) defaults to false
 **consumerId** | [**string**] | ID of the consumer which you want to get or push data from | (optional) 
 **appId** | [**string**] | The ID of your Unify application | (optional) 
 **serviceId** | [**string**] | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API. | (optional) 
...
[`CreateCustomObjectSchemaResponse`](../models/CreateCustomObjectSchemaResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectSchemasAdd(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
```typescript
crmApi.customObjectSchemasAll(body)
```
...
[`GetCustomObjectSchemasResponse`](../models/GetCustomObjectSchemasResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectSchemasAll(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
```typescript
crmApi.customObjectSchemasDelete(body)
```
...
[`DeleteCustomObjectSchemaResponse`](../models/DeleteCustomObjectSchemaResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectSchemasDelete(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
```typescript
crmApi.customObjectSchemasOne(body)
```
...
[`GetCustomObjectSchemaResponse`](../models/GetCustomObjectSchemaResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectSchemasOne(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
```typescript
crmApi.customObjectSchemasUpdate(body)
```
...
[`UpdateCustomObjectSchemaResponse`](../models/UpdateCustomObjectSchemaResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectSchemasUpdate(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **customObject** | [CustomObject](../models/CustomObject.md)|  |
...
[`CreateCustomObjectResponse`](../models/CreateCustomObjectResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectsAdd(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
[`GetCustomObjectsResponse`](../models/GetCustomObjectsResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectsAll(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
```typescript
crmApi.customObjectsDelete(body)
```
...
[`DeleteCustomObjectResponse`](../models/DeleteCustomObjectResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectsDelete(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
[`GetCustomObjectResponse`](../models/GetCustomObjectResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectsOne(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
```typescript
crmApi.customObjectsUpdate(body)
```
...
[`UpdateCustomObjectResponse`](../models/UpdateCustomObjectResponse.md)
...
try {
  const { data } = await apideck.crm.customObjectsUpdate(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
