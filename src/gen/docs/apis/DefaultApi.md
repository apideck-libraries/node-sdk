...
try {
  const { data } = await apideck.undefined.filesAll(params)
...
try {
  const { data } = await apideck.undefined.filesDelete(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
try {
  const { data } = await apideck.undefined.filesDownload(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
...
try {
  const { data } = await apideck.undefined.filesOne(params)
  console.log('API called successfully', data)
} catch (error) {
  console.error(error)
  return error.json()
