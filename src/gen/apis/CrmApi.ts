...
export class CrmApi extends runtime.BaseAPI {
  ...
  async usersAddRaw(
    ...
    if (requestParameters.user1 === null || requestParameters.user1 === undefined) {
      throw new runtime.RequiredError(
        'user1',
        'Required parameter requestParameters.user1 was null or undefined when calling usersAdd.'
      )
    }
    ...
    const response = await this.request({
      ...
      headers: headerParameters,
      query: queryParameters,
      body: User1ToJSON(requestParameters.user1)
    })
  ...
  async usersUpdateRaw(
    ...
    if (requestParameters.user1 === null || requestParameters.user1 === undefined) {
      throw new runtime.RequiredError(
        'user1',
        'Required parameter requestParameters.user1 was null or undefined when calling usersUpdate.'
      )
    }
