...
import {
  ...
  GetHrisJobResponse,
  GetHrisJobResponseFromJSON,
  GetHrisJobsResponse,
  GetHrisJobsResponseFromJSON,
  GetPayrollResponse,
...
export interface HrisApiJobsAllRequest {
  employeeId: string
  raw?: boolean
  consumerId?: string
  appId?: string
...
export interface HrisApiJobsOneRequest {
  jobId: string
  employeeId: string
  raw?: boolean
  consumerId?: string
...
export class HrisApi extends runtime.BaseAPI {
   ...
   */
  async jobsAllRaw(
    requestParameters: HrisApiJobsAllRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<GetHrisJobsResponse>> {
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        'employeeId',
        'Required parameter requestParameters.employeeId was null or undefined when calling jobsAll.'
      )
    }
    ...
    const response = await this.request(
      {
        path: `/hris/jobs/employees/{employee_id}`.replace(
          `{${'employee_id'}}`,
          encodeURIComponent(String(requestParameters.employeeId))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      GetHrisJobsResponseFromJSON(jsonValue)
    )
  }
   ...
   */
  async jobsOneRaw(
    requestParameters: HrisApiJobsOneRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<GetHrisJobResponse>> {
    if (requestParameters.jobId === null || requestParameters.jobId === undefined) {
      throw new runtime.RequiredError(
        'jobId',
        'Required parameter requestParameters.jobId was null or undefined when calling jobsOne.'
      )
    }
    ...
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        'employeeId',
        'Required parameter requestParameters.employeeId was null or undefined when calling jobsOne.'
      )
    }
    ...
    const response = await this.request(
      {
        path: `/hris/jobs/employees/{employee_id}/jobs/{job_id}`
          .replace(`{${'job_id'}}`, encodeURIComponent(String(requestParameters.jobId)))
          .replace(`{${'employee_id'}}`, encodeURIComponent(String(requestParameters.employeeId))),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters
    ...
    return new runtime.JSONApiResponse(response, jsonValue => GetHrisJobResponseFromJSON(jsonValue))
  }
