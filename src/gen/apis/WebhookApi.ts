...
export class WebhookApi extends runtime.BaseAPI {
  ...
  async webhooksAddRaw(
    ...
    if (
      requestParameters.createWebhookRequest === null ||
      requestParameters.createWebhookRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'createWebhookRequest',
        'Required parameter requestParameters.createWebhookRequest was null or undefined when calling webhooksAdd.'
      )
    }
  ...
  async webhooksUpdateRaw(
    ...
    if (
      requestParameters.updateWebhookRequest === null ||
      requestParameters.updateWebhookRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'updateWebhookRequest',
        'Required parameter requestParameters.updateWebhookRequest was null or undefined when calling webhooksUpdate.'
      )
    }
