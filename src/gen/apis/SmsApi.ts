 ...
 *
 * The version of the OpenAPI document: 8.14.0
 *
 *
...
export class SmsApi extends runtime.BaseAPI {
   ...
   * Create Message
   */
  async messagesAdd(requestParameters: SmsApiMessagesAddRequest): Promise<CreateMessageResponse> {
    const response = await this.messagesAddRaw(requestParameters)
   ...
   * List Messages
   */
  async messagesAll(requestParameters: SmsApiMessagesAllRequest): Promise<GetMessagesResponse> {
    const response = await this.messagesAllRaw(requestParameters)
    return await response.value()
  }
  ...
  async messagesDelete(
    ...
    const response = await this.messagesDeleteRaw(requestParameters)
    return await response.value()
  }
   ...
   * Get Message
   */
  async messagesOne(requestParameters: SmsApiMessagesOneRequest): Promise<GetMessageResponse> {
    const response = await this.messagesOneRaw(requestParameters)
    return await response.value()
  }
  ...
  async messagesUpdate(
    ...
    const response = await this.messagesUpdateRaw(requestParameters)
    return await response.value()
  }
}
