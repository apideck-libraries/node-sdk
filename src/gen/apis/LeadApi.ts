...
export class LeadApi extends runtime.BaseAPI {
   ...
   * Create lead
   */
  async leadsAdd(requestParameters: LeadApiLeadsAddRequest): Promise<InlineResponse201> {
   ...
   * List leads
   */
  async leadsAll(requestParameters: LeadApiLeadsAllRequest): Promise<InlineResponse200> {
   ...
   * Delete lead
   */
  async leadsDelete(requestParameters: LeadApiLeadsDeleteRequest): Promise<InlineResponse201> {
   ...
   * Get lead
   */
  async leadsOne(requestParameters: LeadApiLeadsOneRequest): Promise<InlineResponse2001> {
   ...
   * Update lead
   */
  async leadsUpdate(requestParameters: LeadApiLeadsUpdateRequest): Promise<InlineResponse201> {
