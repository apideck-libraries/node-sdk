...
export class VaultApi extends runtime.BaseAPI {
  ...
  async connectionsUpdateRaw(
    ...
    if (
      requestParameters.createConnectionRequestBody === null ||
      requestParameters.createConnectionRequestBody === undefined
    ) {
      throw new runtime.RequiredError(
        'createConnectionRequestBody',
        'Required parameter requestParameters.createConnectionRequestBody was null or undefined when calling connectionsUpdate.'
      )
    }
    ...
    const response = await this.request({
      ...
      headers: headerParameters,
      query: queryParameters,
      body: CreateConnectionRequestBodyToJSON(requestParameters.createConnectionRequestBody)
    })
