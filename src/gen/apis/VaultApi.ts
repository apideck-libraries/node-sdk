...
export class VaultApi extends runtime.BaseAPI {
  ...
  async connectionsGetSettings(
    ...
    const response = await this.connectionsGetSettingsRaw(requestParameters, initOverrides)
    return await response.value()
  }
  ...
  async connectionsUpdateSettings(
    ...
    const response = await this.connectionsUpdateSettingsRaw(requestParameters, initOverrides)
    return await response.value()
  }
  ...
  async consumersRequestCounts(
    ...
    const response = await this.consumersRequestCountsRaw(requestParameters, initOverrides)
    return await response.value()
  }
