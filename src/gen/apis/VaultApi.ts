...
import {
  ...
  GetCustomMappingsResponseFromJSON,
  GetLogsResponse,
  ...
  ValidateConnectionStateResponseFromJSON
} from '../models'
import * as runtime from '../runtime'

export interface VaultApiConnectionCustomMappingsAllRequest {
  unifiedApi: string
  serviceId: string
  resource: string
  consumerId?: string
...
export interface VaultApiCustomMappingsAllRequest {
  unifiedApi: string
  serviceId: string
  consumerId?: string
  appId?: string
...
export interface VaultApiValidateConnectionStateRequest {
  serviceId: string
  unifiedApi: string
  consumerId?: string
  appId?: string
...
export class VaultApi extends runtime.BaseAPI {
   ...
   */
  async connectionCustomMappingsAllRaw(
    requestParameters: VaultApiConnectionCustomMappingsAllRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<GetCustomMappingsResponse>> {
    if (requestParameters.unifiedApi === null || requestParameters.unifiedApi === undefined) {
      throw new runtime.RequiredError(
        'unifiedApi',
        'Required parameter requestParameters.unifiedApi was null or undefined when calling connectionCustomMappingsAll.'
      )
    }
    ...
    if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
      throw new runtime.RequiredError(
        'serviceId',
        'Required parameter requestParameters.serviceId was null or undefined when calling connectionCustomMappingsAll.'
      )
    }
    ...
    if (requestParameters.resource === null || requestParameters.resource === undefined) {
      throw new runtime.RequiredError(
        'resource',
        'Required parameter requestParameters.resource was null or undefined when calling connectionCustomMappingsAll.'
      )
    }
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      GetCustomMappingsResponseFromJSON(jsonValue)
    )
  }
   ...
   * List connection custom mappings
   */
  async connectionCustomMappingsAll(
    requestParameters: VaultApiConnectionCustomMappingsAllRequest,
    initOverrides?: RequestInit
  ): Promise<GetCustomMappingsResponse> {
    const response = await this.connectionCustomMappingsAllRaw(requestParameters, initOverrides)
   ...
   */
  async customMappingsAllRaw(
    requestParameters: VaultApiCustomMappingsAllRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<GetCustomMappingsResponse>> {
    if (requestParameters.unifiedApi === null || requestParameters.unifiedApi === undefined) {
      throw new runtime.RequiredError(
        'unifiedApi',
        'Required parameter requestParameters.unifiedApi was null or undefined when calling customMappingsAll.'
      )
    }
    ...
    if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
      throw new runtime.RequiredError(
        'serviceId',
        'Required parameter requestParameters.serviceId was null or undefined when calling customMappingsAll.'
      )
    }
   ...
   * List custom mappings
   */
  async customMappingsAll(
    requestParameters: VaultApiCustomMappingsAllRequest,
    initOverrides?: RequestInit
  ): Promise<GetCustomMappingsResponse> {
    const response = await this.customMappingsAllRaw(requestParameters, initOverrides)
    return await response.value()
  }
   ...
   */
  async validateConnectionStateRaw(
    requestParameters: VaultApiValidateConnectionStateRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<ValidateConnectionStateResponse>> {
    if (requestParameters.serviceId === null || requestParameters.serviceId === undefined) {
      throw new runtime.RequiredError(
        'serviceId',
        'Required parameter requestParameters.serviceId was null or undefined when calling validateConnectionState.'
      )
    }
    ...
    if (requestParameters.unifiedApi === null || requestParameters.unifiedApi === undefined) {
      throw new runtime.RequiredError(
        'unifiedApi',
        'Required parameter requestParameters.unifiedApi was null or undefined when calling validateConnectionState.'
      )
    }
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      ValidateConnectionStateResponseFromJSON(jsonValue)
    )
  }
   ...
   * Validate Connection State
   */
  async validateConnectionState(
    requestParameters: VaultApiValidateConnectionStateRequest,
    initOverrides?: RequestInit
  ): Promise<ValidateConnectionStateResponse> {
    const response = await this.validateConnectionStateRaw(requestParameters, initOverrides)
    return await response.value()
  }
}
