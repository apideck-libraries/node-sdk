...
import { PayrollTotals, PayrollTotalsFromJSON, PayrollTotalsToJSON } from './PayrollTotals'
...
export function PayrollFromJSONTyped(json: any, ignoreDiscriminator: boolean): Payroll {
  ...
  return {
    ...
    totals: !exists(json, 'totals') ? undefined : PayrollTotalsFromJSON(json['totals']),
...
export function PayrollToJSON(value?: Payroll | null): any {
  ...
  return {
    ...
    totals: PayrollTotalsToJSON(value.totals),
    compensations:
