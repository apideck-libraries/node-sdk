 ...
 *
 * @export
 * @interface EmployeeBankAccounts
 */
export interface EmployeeBankAccounts {
  /**
   * The name of the bank
   * @type {string}
   * @memberof EmployeeBankAccounts
   */
   ...
   * @memberof EmployeeBankAccounts
   */
  account_type?: EmployeeBankAccountsAccountType
  /**
   *
   * @type {string}
   * @memberof EmployeeBankAccounts
 ...
 * @enum {string}
 */
export enum EmployeeBankAccountsAccountType {
  bank_account = 'bank_account',
  credit_card = 'credit_card',
  other = 'other'
}

export function EmployeeBankAccountsFromJSON(json: any): EmployeeBankAccounts {
  return EmployeeBankAccountsFromJSONTyped(json, false)
}

export function EmployeeBankAccountsFromJSONTyped(
  json: any,
...
export function EmployeeBankAccountsToJSON(value?: EmployeeBankAccounts | null): any {
  if (value === undefined) {
    return undefined
  }
  if (value === null) {
