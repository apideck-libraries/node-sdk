...
export function Address4FromJSON(json: any): Address4 {
  return Address4FromJSONTyped(json, false)
}

export function Address4FromJSONTyped(json: any, ignoreDiscriminator: boolean): Address4 {
...
export function Address4ToJSON(value?: Address4 | null): any {
  if (value === undefined) {
    return undefined
  }
  if (value === null) {
