...
export interface Message {
  ...
  readonly id?: string
  /**
   * The number of segments that make up the complete message. Messages can be split up due to the constraints of the message size.
   * @type {number}
   * @memberof Message
   */
  ...
  error?: Error
  /**
   * The ID of the Messaging Service used with the message.
   * @type {string}
   * @memberof Message
   */
...
export function MessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): Message {
  ...
  return {
    ...
    number_of_segments: !exists(json, 'number_of_segments')
      ? undefined
      : json['number_of_segments'],
