...
export interface Compensation {
   ...
   * @memberof Compensation
   */
  payment_frequency?: CompensationPaymentFrequency
}
 ...
 * @enum {string}
 */
export enum CompensationPaymentFrequency {
  weekly = 'weekly',
  biweekly = 'biweekly',
  monthly = 'monthly',
  pro_rata = 'pro-rata',
...
export function CompensationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Compensation {
  ...
  return {
    ...
    payment_frequency: !exists(json, 'payment_frequency') ? undefined : json['payment_frequency']
  }
}
