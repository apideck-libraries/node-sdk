...
export function FormFieldOptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FormFieldOption {
    ...
    return {
        ...
        'options': !exists(json, 'options') ? undefined : ((json['options'] as Array<any>).map(SimpleFormFieldOptionFromJSON)),
    };
}
...
export function FormFieldOptionToJSON(value?: FormFieldOption | null): any {
    ...
    return {
        ...
        'id': value.id,
        'options': value.options === undefined ? undefined : ((value.options as Array<any>).map(SimpleFormFieldOptionToJSON)),
    };
}
