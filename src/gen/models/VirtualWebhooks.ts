...
import {
  ...
  VirtualWebhooksResourcesToJSON
} from './VirtualWebhooksResources'
...
export interface VirtualWebhooks {
   ...
   * @memberof VirtualWebhooks
   */
  resources?: { [key: string]: VirtualWebhooksResources }
}
...
export function VirtualWebhooksFromJSONTyped(
  ...
  return {
    ...
    resources: !exists(json, 'resources')
      ? undefined
      : mapValues(json['resources'], VirtualWebhooksResourcesFromJSON)
  }
}
  ...
  return {
    ...
    resources:
      value.resources === undefined
        ? undefined
        : mapValues(value.resources, VirtualWebhooksResourcesToJSON)
  }
}
