...
export function ConnectionDefaultsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionDefaults {
    ...
    return {
        ...
        'options': !exists(json, 'options') ? undefined : ((json['options'] as Array<any>).map(FormFieldOptionFromJSON)),
...
export function ConnectionDefaultsToJSON(value?: ConnectionDefaults | null): any {
    ...
    return {
        ...
        'id': value.id,
        'options': value.options === undefined ? undefined : ((value.options as Array<any>).map(FormFieldOptionToJSON)),
