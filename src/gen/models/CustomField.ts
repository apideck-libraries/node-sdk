...
import { exists, mapValues } from '../runtime';
 import {
     ...
     string | number | boolean | Array<string&gt;FromJSON,
     string | number | boolean | Array<string&gt;FromJSONTyped,
     string | number | boolean | Array<string&gt;ToJSON,
...
export function CustomFieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomField {
    ...
    return {
        ...
        'value': !exists(json, 'value') ? undefined : <string | number | boolean | Array<string>>(json['value']),
    };
}
