...
import { UnitOfMeasure, UnitOfMeasureFromJSON, UnitOfMeasureToJSON } from './UnitOfMeasure'
...
export function InvoiceItemSalesDetailsFromJSONTyped(
  ...
  return {
    ...
    unit_of_measure: !exists(json, 'unit_of_measure')
      ? undefined
      : UnitOfMeasureFromJSON(json['unit_of_measure']),
...
export function InvoiceItemSalesDetailsToJSON(value?: InvoiceItemSalesDetails | null): any {
  ...
  return {
    ...
    unit_of_measure: UnitOfMeasureToJSON(value.unit_of_measure),
