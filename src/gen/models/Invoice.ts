...
import {
  ...
  InvoicePaymentAllocationsFromJSON,
  InvoicePaymentAllocationsToJSON
...
export interface Invoice {
   ...
   * @type {Array<InvoicePaymentAllocations>}
   * @memberof Invoice
   */
  payment_allocations?: Array<InvoicePaymentAllocations> | null
  /**
...
export function InvoiceFromJSONTyped(json: any, ignoreDiscriminator: boolean): Invoice {
  ...
  return {
    ...
    payment_allocations: !exists(json, 'payment_allocations')
      ? undefined
      : json['payment_allocations'] === null
      ? null
      : (json['payment_allocations'] as Array<any>).map(InvoicePaymentAllocationsFromJSON),
...
export function InvoiceToJSON(value?: Invoice | null): any {
  ...
  return {
    ...
    payment_allocations:
      value.payment_allocations === undefined
        ? undefined
        : value.payment_allocations === null
        ? null
        : (value.payment_allocations as Array<any>).map(InvoicePaymentAllocationsToJSON),
