...
import {
  ...
  ConnectorWebhookSupportTypeFromJSON,
  ConnectorWebhookSupportTypeToJSON
} from './ConnectorWebhookSupportType'
import {
...
export interface Connector {
  ...
  /**
   *
   * @type {ConnectorWebhookSupportType}
   * @memberof Connector
   */
  webhook_support_type?: ConnectorWebhookSupportType
  /**
...
export function ConnectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Connector {
  ...
  return {
    ...
    webhook_support_type: !exists(json, 'webhook_support_type')
      ? undefined
      : ConnectorWebhookSupportTypeFromJSON(json['webhook_support_type']),
...
export function ConnectorToJSON(value?: Connector | null): any {
  ...
  return {
    ...
    webhook_support_type: ConnectorWebhookSupportTypeToJSON(value.webhook_support_type),
    oauth_scopes:
