...
import {
  ...
  EcommerceOrderRefundFromJSON,
  EcommerceOrderRefundToJSON
...
export interface EcommerceOrder {
  ...
  /**
   *
   * @type {Array<EcommerceOrderRefund>}
   * @memberof EcommerceOrder
   */
  refunds?: Array<EcommerceOrderRefund>
  /**
   *
   * @type {CustomMappings}
   * @memberof EcommerceOrder
...
export function EcommerceOrderFromJSONTyped(
  ...
  return {
    ...
    refunds: !exists(json, 'refunds')
      ? undefined
      : (json['refunds'] as Array<any>).map(EcommerceOrderRefundFromJSON),
  ...
  return {
    ...
    refunds:
      value.refunds === undefined
        ? undefined
        : (value.refunds as Array<any>).map(EcommerceOrderRefundToJSON),
