...
import { Department1, Department1FromJSON, Department1ToJSON } from './Department1'
...
export function JobFromJSONTyped(json: any, ignoreDiscriminator: boolean): Job {
  ...
  return {
    ...
    department: !exists(json, 'department') ? undefined : Department1FromJSON(json['department']),
...
export function JobToJSON(value?: Job | null): any {
  ...
  return {
    ...
    department: Department1ToJSON(value.department),
