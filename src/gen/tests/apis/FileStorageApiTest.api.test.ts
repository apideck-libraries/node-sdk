...
describe('FileStorageApi', () => {
  describe('#filesAll', () => {
    ...
    it('should call Apideck with expected params', async () => {
      ...
      const params = {} as any
      const current = (await file) - storage.filesAll(params)
  ...
  describe('#filesDelete', () => {
    ...
    it('should call Apideck with expected params', async () => {
      ...
      const current = (await file) - storage.filesDelete(params)
  ...
  describe('#filesDownload', () => {
    ...
    it('should call Apideck with expected params', async () => {
      ...
      const current = (await file) - storage.filesDownload(params)
  ...
  describe('#filesOne', () => {
    ...
    it('should call Apideck with expected params', async () => {
      ...
      const current = (await file) - storage.filesOne(params)
